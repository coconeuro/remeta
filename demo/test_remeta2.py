...
cfg.type2_param_noise.bounds = (0.01, 10)
params_true = dict(
    type1_noise=0.5,
    # type1_bias=0,
    type2_noise=0.25,
    type2_criteria=[1/3, 0.3, 0.1, 0.1],
...
data = remeta.simu_data(nsubjects=1, nsamples=5000, params=params_true, squeeze=True, x_stim_stepsize=0.25,
                        cfg=cfg)
