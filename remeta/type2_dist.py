...
TYPE2_NOISE_DISTS = (
    ...
    'lognorm_mean_std', 'lognorm_mean', 'lognorm_mode_std', 'lognorm_mode', 'lognorm_median_std',
    ...
    'truncated_lognorm_mode_std', 'truncated_lognorm', 'truncated_lognorm_mode', 'truncated_lognorm_mean'
)

TYPE2_NOISE_DISTS_REPORT_ONLY = (
    'beta_mode_std', 'beta_mode', 'beta_mean_std',
    'truncated_lognorm_mode_std', 'truncated_lognorm_mode', 'truncated_lognorm', 'truncated_lognorm_mean'
)
...
def get_type2_dist(type2_dist, type2_center, type2_noise, type2_noise_type='noisy_report'):
    """
